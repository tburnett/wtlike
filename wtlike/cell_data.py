...
__all__ = ['time_bin_edges', 'contiguous_bins', 'CellData', 'concatenate_cells', 'partition_cells', 'phase_cells']
...
class CellData(SourceData):
    ...
    def get_cells(self, exposure_factor=1e-6):
        ...
        Thus the `e`  cell entry is the weighted exposure for the cell in units $cm^2 Ms$.
        """
