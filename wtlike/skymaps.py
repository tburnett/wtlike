...
__all__ = ['valid', 'plot_week', 'SquareWCS', 'sun_dir', 'make_ltmap', 'FermiMonth']
...
def make_ltmap(time_range, sigma=1, show_sun=True,
               figsize=(9,4), utc_flag=True,fignum=1, **kwargs):
...
class FermiMonth():
    ...
    def __init__(self):
        ...
        a,b = first_data, MJD('now')
        self.mm = np.arange(a,round(b),30)
    def __len__(self):
