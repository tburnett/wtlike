...
__all__ = ['power_spectrum_fft', 'power_spectrum_plot', 'TimeSeries', 'Sinc']
...
class Sinc():
    ...
    def plot(self, xlim=None, ax=None, pticks=None, **kwargs):
        ...
        ax.twiny().set(xlabel='Period' if toplabel is None else toplabel,
